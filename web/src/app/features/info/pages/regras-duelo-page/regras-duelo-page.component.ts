    ...
    areas: [
      {
        ...
        points: 1,
        color: "#00ff00",
        description: "Tronco, braços, pernas",
      },
      {
        name: "Áreas Críticas",
        points: 2,
        color: "#00ffff",
        description: "Cabeça (apenas topo e laterais)",
      },
      {
        name: "Áreas Proibidas",
        points: 0,
        color: "#ff0000",
        description: "Face, pescoço, virilha, seios",
      },
      {
        name: "Inválidas",
        points: 0,
        color: "#cccccc",
        description: "Mãos segurando armas, pés no chão",
      },
    ],
  };
}

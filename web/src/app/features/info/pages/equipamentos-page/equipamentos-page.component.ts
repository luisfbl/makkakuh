  ...
  weaponTypes: WeaponType[] = [
    {
      title: "Espadas",
      description:
        "É a arma mais tradicional do swordplay. A lâmina pode ser reta ou curva e o uso de bainha é opcional.",
      details: [
    ...
    },
    {
      title: "Escudos",
      description:
        "Pode ser feitos de EVA, papelão ou material similar (madeira, metal e outros materiais rígidos demais são proibidos). O tamanho pode variar entre o broquel (20 cm) e o targu (1,5 m), com centenas de possibilidades de formatos.",
      details: [
    ...
    },
    {
      title: "Adagas",
      description:
        "Usada para combate em curta distância, a adaga pode ser confeccionada apenas de espuma ou feita do modo comum de lâminas. Adagas não podem ultrapassar 40 cm, ou serão consideradas espadas.",
      details: [
    ...
    },
    {
      title: "Machados",
      description:
        "Machados são considerados armas de haste e são feitos principalmente para golpes giratórios (leia as regras gerais no topo). Não recomenda-se o uso de conectores de cano, pois a arma irá ter vida útil muito curta assim.",
      details: [
    ...
    },
    {
      ...
      description:
        "O arco nunca é uma arma de ataque corpo-a-corpo. Pode ser feito de cano de PVC com linha encerada ou similar. A tensão do arco não pode ultrapassar 20 libras de potência. Não é permitido arco composto ou com roldanas.",
      details: [
    ...
    },
    {
      title: "Maças",
      description:
        'Essa arma pode ser feita para uma ou duas mãos. A área de dano, chamada de "cabeça", pode (mas não é obrigatório) ser reforçada com espuma de alta densidade ou EVA, mas é obrigatório que seja completamente revestida com uma camada de 4 cm de espuma de baixa densidade (flutuador de piscina ou PI).',
      details: [
    ...
    },
    {
      title: "Bestas",
      description:
        "A besta, ou arco em cruz, pode ser feito de madeira, fibra de vidro ou pvc, com corda de nylon ou linha encerada trançada.",
      details: [
    ...
    },
    {
      title: "Martelos",
      description:
        "Também chamado de malho, essa arma acaba por ser bem mais pesada que a média, por isso suas especificações de segurança são reforçadas.",
      details: [
    ...
    },
    {
      title: "Alabardas",
      description:
        "A alabarda é uma mistura de lança e machado, podendo ser usada para corte, normalmente pelos dois lados da folha de lâmina, e perfuração pela ponta.",
      details: [
    ...
    },
    {
      ...
      description:
        "O bastão é uma arma de haste com duas pontas, feito para combate frontal ou giratório. As extremidades são as únicas áreas de dano, e devem ser fabricadas conforme as regras. O meio deve ser acolchoado conforme a regras de cabos e hastes, não podendo ser utilizado para ataques, mas servindo para bloqueios.",
      details: [
  ...
  armorPieces: ArmorPiece[] = [
    {
      ...
      description:
        "Peça ou conjunto de peças que protege desde a junta do ombro até o cotovelo, sendo usada em movimentos para bloquear golpes contra o tórax.",
      color: "#FFD700",
    },
    {
      name: "ELMO",
      description:
        "Protege a cabeça e possivelmente o pescoço contra impactos e contra o sol. Esse item é recomendado, principalmente para escudeiros. O uso do elmo não libera os golpes na cabeça, que continuam proibidos.",
    ...
    },
    {
      name: "BRAÇADEIRA",
      description:
        'Protege do cotovelo até o pulso, podendo ser utilizada para bloqueios como "varridas". Pode incluir a área do cotovelo, opcionalmente.',
      color: "#FF69B4",
    },
    {
      name: "GUARDA-CORAÇÃO",
      description:
        "Essa proteção de origem greco-romana, normalmente fixa por faixas, é a única peça de armadura que poderá ser fixada no tórax, bloqueando apenas um lado do peito do guerreiro. Não é permitido o uso de duas placas desse tipo.",
      color: "#87CEEB",
    },
    {
      name: "MANOPLA PUNCH",
      description:
        "Essa peça protege as costas da mão até a altura do pulso. Com ela é permitido efetuar tapas com as costas da mão ou socos com a finalidade de bloquear ataques. Essa peça não protege a palma da mão, não permitindo de nenhuma forma segurar a arma do adversário.",
      color: "#90EE90",
    },
    {
      name: "PERNEIRA",
      description:
        "Protege a região da coxa, indo da virilha até logo acima do joelho, podendo (opcional) conter uma proteção para a virilha (soqueira), sem contar como equipamento adicional.",
      color: "#FFB6C1",
    },
    {
      name: "GREVA / CANALEIRA",
      description:
        "Peça que protege a canela. Podem ir do joelho ao calcanhar.",
      color: "#FA8072",
    },
  ];
  ...
  securityRules = [
    {
      title: "Áreas de Dano",
      content:
        '(normalmente, mas nem sempre, chamadas de "lâminas") devem ter um mínimo de 2,5 cm de espuma (em cada lado) e 5 cm nas pontas. Armas de EVA devem ser planejadas com alguma forma de amortecimento do impacto por cima do EVA (recomenda-se espuma). Devem ser revestidas de fita (Silver Tape).',
    },
    {
      title: "A espuma",
      content:
        "poderá ser de flutuador de piscina, PI ou similar e deverá ser colada no cano com cola de sapateiro ou cola de contato. Não",
    },
    {
      title: "Por questão de segurança, o Cano",
      content:
        "jamais pode estar exposto em nenhuma parte da arma, mesmo no cabo da arma, devendo ser recoberto com material anti-deslizante e é extremamente recomendado que seja feito de forma a amortecer impactos.",
    },
    {
      title: "Hastes de armas",
      content:
        "devem ser, obrigatoriamente, cobertas com espuma, EVA, borracha ou similar, de forma de reduzir o dano em caso de possível impacto. Em armas de estocada (lanças, tridentes...), esse revestimento deve ser feito em 1/3 da haste, na região mais próxima à lâmina. Em armas de corte (machados, foices...), esse revestimento deve ser feito em 1/2 da área da haste.",
    },
    {
      title: "A ponta do cabo",
      content:
        "deve ser protegida por material anti-impacto. O ideal é uma esfera de espuma, EVA, borracha, ou similar, fixada com cola e fita, chamada de Pomo, com espessura mínima de 1 cm.",
    },
    {
      title: "Armas de Arremesso",
      content:
        "devem, obrigatoriamente, ser fabricadas de material que não cause dano ao impacto em nenhuma parte como EVA ou material mágico. Elas não podem possuir cano interno, mas é permitido que tenham núcleos de fibra de vidro recoberto de EVA. Essas armas não podem ultrapassar 40 cm, exceto por lanças curtas (dardos ou azagaias), que podem chegar até 1,5 m. A região de contato deve ser revestida de espuma como uma lâmina comum.",
    },
  ];
}

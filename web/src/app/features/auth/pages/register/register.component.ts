...
export class RegisterComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (tempProfile) {
      try {
        ...
        this.userImageUrl = this.cdnService.getImageUrl(
  ...
  registerWithGoogle(): void {
    ...
    this.authService.initiateOAuth("google").subscribe({
      ...
      error: (error: any) => {
        this.errorMessage =
          "Falha ao iniciar o cadastro com Google. Tente novamente.";
        this.isLoading = false;
  ...
  completeRegistration(): void {
    ...
    this.authService.completeSignUp(userData).subscribe({
      ...
      error: (error: any) => {
        this.errorMessage =
          "Falha ao completar o cadastro. Verifique os dados e tente novamente.";
        this.isLoading = false;

  ...
  navItems: NavItem[] = [
    {
      ...
      route: "/quem-somos",
      subItems: [
        { label: "Leis e Regras do Clã", route: "/info/leis-regras" },
        { label: "Organização do Clã", route: "/info/organizacao" },
        { label: "Hierarquia e Patentes", route: "/info/hierarquia" },
        { label: "Comitê Feminino", route: "/info/comite-feminino" },
      ],
    },
    {
      key: "swordplay",
      label: "O que é swordplay?",
      route: "/info/o-que-e-swordplay",
      subItems: [
        { label: "Regras de Duelo", route: "/info/regras-duelo" },
        { label: "Regras de Massiva", route: "/info/regras-massiva" },
        { label: "Equipamentos", route: "/info/equipamentos" },
        { label: "Glossário do Swordplay", route: "/info/glossario" },
      ],
    },
    {
      key: "larp",
      label: "O que é LARP?",
      route: "/info/o-que-e-larp",
    },
    {
      key: "mais",
      label: "Mais",
      subItems: [
        ...
        { label: "Perguntas Frequentes", route: "/info/faq" },
  ...
  footerSections: FooterSection[] = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "LARP", route: "/info/o-que-e-larp" },
        { label: "Regras" },
        { label: "Equipamentos" },
      ],
    },
